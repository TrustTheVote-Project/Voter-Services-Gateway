...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { dateOfBirth: @voter.dateOfBirth, email: @voter.email, name: @voter.name, phone: @voter.phone }
    end
  ...
  test "should update voter" do
    put :update, id: @voter, voter: { dateOfBirth: @voter.dateOfBirth, email: @voter.email, name: @voter.name, phone: @voter.phone }
    assert_response 204
  end
